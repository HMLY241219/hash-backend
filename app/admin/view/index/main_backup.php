    ...
    <div class="col-sm-3 ui-sortable">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                ...
                <small><a href="javascript:;" class="opFrames" data-name="会员管理" data-href="{:Url('user.user/index')}">今日登录用户</a></small>
            </div>
        </div>
    </div>
    <div class="col-sm-3 ui-sortable">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                ...
                <small><a href="javascript:;" class="opFrames" data-name="会员管理" data-href="{:Url('user.user/index')}">本月登录用户</a></small>
            </div>
        </div>
    </div>
