...
<div id="wrapper">
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element admin_open">
                        <!--<span>
                            <img alt="image" class="imgbox" src="" onerror="javascript:this.src='{__ADMIN_PATH}images/admin_logo.png';"/>
                        </span>-->
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="clear" style="margin-top: 20px;">
                                ...
                                <span class="text-muted text-xs block">{$role_name ?: '管理员'}<b class="caret"></b></span>
                            </span>
                        </a>
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            <li><a class="J_menuItem admin_close" href="{:url('setting.systemAdmin/admin_info')}">个人资料</a></li>
                            <li class="divider"></li>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        <div class="row content-tabs" @touchmove.prevent  >
            ...
            <!--<a href="javascript:void(0);" class="roll-nav roll-right J_notice" data-toggle="dropdown" aria-expanded="true" title="消息" style="right:293px">
                <i class="fa fa-bell"></i> <span class="badge badge-danger" id="msgcount">0</span>
            </a>-->
            <ul class="dropdown-menu dropdown-alerts dropdown-menu-right" >
                <li>
                    <a class="J_menuItem" href="{:url('order.store_order/index')}">
                        <div>
                            <i class="fa fa-building-o"></i> 待发货 <span class="pull-right text-muted small" id="ordernum">0个</span>
                        </div>
                    </a>
                </li>
                <li class="divider"></li>
