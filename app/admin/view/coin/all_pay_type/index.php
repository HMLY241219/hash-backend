...
<script>
    ...
    layui.use(['table','form','layer','laydate'], function () {
        ...
        table.render({
            ...
            ,page : true
            ,cols: [[
                {field: 'createtime', title: '接入时间', minWidth: 110, sort: true,fixed: 'left'},
                {field: 'currency', title: '币种', minWidth: 100,fixed: 'left'},
                {field: 'name', title: '三方ID', minWidth: 100,fixed: 'left'},
                {field: 'englishname', title: '三方支付名称', minWidth: 100},
                {field: 'fee_bili', title: '三方费率', minWidth: 100},
                {field: 'recharge_suc_count_yes', title: '昨日充值次数', minWidth: 110},
                {field: 'recharge_suc_count', title: '累计充值次数', minWidth: 110},
                {field: 'recharge_money_yes', title: '昨日充值金额', minWidth: 110},
                {field: 'recharge_money', title: '累计充值金额', minWidth: 110},
                {field: 'recharge_rate', title: '充值总成功率', minWidth: 110},
                {field: 'recharge_rate_yes', title: '昨日充值成功率', minWidth: 110},
                {field: 'ave_time', title: '总平均入款时间', minWidth: 110},
                {field: 'ave_time_yes', title: '昨日平均入款时间', minWidth: 110},
