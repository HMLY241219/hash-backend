...
<script type="text/html" id="type">
    {{# if(d.type == 1){ }}
    <span class="layui-btn layui-btn-primary layui-btn-xs layui-border-blue">银行卡</span>
    {{# }else if(d.type == 2){ }}
    <span class="layui-btn layui-btn-primary layui-btn-xs layui-border-blue">UPI</span>
    {{# }else if(d.type == 3){ }}
    <span class="layui-btn layui-btn-xs layui-btn-warm">钱包</span>
    {{# }else{ }}
