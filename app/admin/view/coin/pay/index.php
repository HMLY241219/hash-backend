                ...
                <div class="layui-card layui-form" lay-filter="form">
                    <div class="layui-card-body layui-row layui-col-space10">
                        ...
                        <div class="layui-inline">
                            <input class="layui-input" name="a_name"  autocomplete="off" placeholder="充值渠道">
                        </div>
    ...
    layui.use(['table','form','layer','laydate'], function () {
        ...
        table.render({
            ...
            ,cols: [[
                ...
                //     }},
                {field: 'minmoney', title: '充值最小金额(元)', minWidth: 100, templet(d){
                        return d.minmoney /100
                    }},
                {field: 'maxmoney', title: '充值最大金额(元)', minWidth: 100, templet(d) {
                        return d.maxmoney /100
                    }},
                {field: 'fee_bili', title: '手续费(比例)', minWidth: 100, },
                ...
                {
                    field: 'wake_status', title: '是否是唤醒通道', minWidth: 130,templet:"#wake_status"
                },
                {
                ...
                {field: 'video_url', title: '视频链接', minWidth: 120, sort: true},
