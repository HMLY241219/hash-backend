...
<script type="text/html" id="type">
    ...
    {{# }else if(d.type == 4){ }}
    <span class="layui-btn layui-btn-xs layui-btn-danger">钱包充值</span>
    {{# }else{ }}
    ...
    layui.use(['table','form','layer','laydate'], function () {
        ...
        table.render({
            ...
            ,cols: [[
                ...
                {field: 'englishname', title: '客户端名称', minWidth: 110},
                ...
                {field: 'min_money', title: '最小充币提币金额', minWidth: 110, templet(d) {
