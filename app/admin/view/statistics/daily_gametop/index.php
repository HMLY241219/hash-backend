            ...
            <div class="table-reload">
                <div class="layui-card layui-form" lay-filter="form">
                    <div class="layui-card-body layui-row layui-col-space10">
                        ...
                        <div class="layui-inline">
                            <select name="terrace/name" lay-filter="">
...
<script>
    ...
    layui.use(['table','form','layer','laydate'], function () {
        ...
        table.render({
            ...
            ,page : true
            ,cols: [[
                {field: 'date', title: '日期', minWidth: 110, sort: true,fixed: 'left'},
                {field: 'terrace_name', title: '厂商', minWidth: 100,fixed: 'left'},
                {field: 'englishname', title: '游戏名', minWidth: 110,fixed: 'left'},
                ...
                {field: 'bet_score', title: '游戏押注', minWidth: 100, templet(d){ return (d.bet_score/100).toFixed(0)}},
                {field: 'coin_change', title: '游戏FJ', minWidth: 130,templet(d){ return (d.coin_change/100).toFixed(0)}},
                ...
                {field: 'service_score', title: '税收', minWidth: 100, templet(d){ return d.service_score/100}},
                {field: 'bet_score', title: '人均押注', minWidth: 130, templet(d){ return (d.user_count ? ((d.bet_score/100)/d.user_count).toFixed(0) : '0.00')}},
                {field: 'final_score', title: '游戏盈亏', minWidth: 150, templet: function (d) {return d.final_score/100}},
                {field: 'final_score', title: '人均盈亏', minWidth: 110, templet(d){ return (d.user_count ? ((d.final_score/100)/d.user_count).toFixed(2) : '0.00')}},

                //{field: 'pay_user_count', title: '付费人数', minWidth: 100},
                {field: 'game_count', title: '游戏局数', minWidth: 100},
                /*{field: 'ai_bet_score', title: 'AI押注', minWidth: 130,templet(d){ return (d.ai_bet_score/100).toFixed(0)}},
                {field: 'ai_coin_change', title: 'AI FJ', minWidth: 130,templet(d){ return (d.ai_coin_change/100).toFixed(0)}},
                {field: 'ai_final_score', title: 'AI盈亏', minWidth: 130,templet(d){ return (d.ai_final_score/100).toFixed(0)}},*/
