    ...
    layui.use(['table','form','layer','laydate'], function () {
        ...
        table.render({
            ...
            ,cols: [[
                ...
                {field: 'total_cash_water_score', title: '总投注', minWidth: 150, align:'center',templet(d) {return (d.total_bonus_water_score+d.total_cash_water_score)/100}},
                {field: 'cash_total_score', title: '总SY', minWidth: 150, align:'center',templet(d) {return (d.cash_total_score + d.bonus_total_score)/100}},
                // {field: 'cash_total_score', title: '奖励情况', minWidth: 150, align:'center',templet(d) {return `<span id='flow'>点击查看</span>` }},
                {field: 'cash_total_score', title: '奖励情况', minWidth: 150, align:'center',templet(d) {return `<span lay-event="flow">点击查看</span>` }},
            ]]
