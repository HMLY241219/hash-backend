    ...
    layui.use(['table','form','layer','laydate'], function () {
        ...
        table.render({
            ...
            ,cols: [[
                ...
                {field: 'minmoney', title: '最小充值金额',align: "center", minWidth: 120,templet(d){
                        return `${(d.minmoney/100).toFixed(2)}`
                    }},
                {field: 'maxmoney', title: '最大充值金额',align: "center", minWidth: 120,templet(d){
                        return `${(d.maxmoney/100).toFixed(2)}`
                    }},
                {field: 'zs_cash', title: '赠送Cash',align: "center", minWidth: 120,templet(d){
                        return `${(d.zs_cash/100).toFixed(2)}`
                    }},
                {field: 'zs_bonus', title: '赠送Bonus',align: "center", minWidth: 120,templet(d){
