...
<script type="text/html" id="type">
    {{# if(d.type == 1){ }}
    <span class="layui-btn layui-btn-primary layui-btn-xs layui-border-blue" style="color: #7F007F">每天</span>
    {{# }else if(d.type == 2){ }}
    <span class="layui-btn layui-btn-primary layui-btn-xs layui-border-normal" style="color: #FFA00A">每周</span>
    {{# }else{ }}
    <span class="layui-btn layui-btn-primary layui-btn-xs layui-border-orange" style="color: #b084eb">每月</span>
    {{# }; }}
</script>
    ...
    layui.use(['table','form','layer','laydate'], function () {
        ...
        table.render({
            ...
            ,cols: [[
                ...
                {field: 'time', title: '参与时间', align: "center", minWidth: 110},
                {field: 'type', title: '类型', align: "center", minWidth: 80,templet:"#type"},
                {field: 'day', title: '几号或周几', align: "center", minWidth: 110},
