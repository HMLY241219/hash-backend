    ...
    layui.use(['table','form','layer','laydate'], function () {
        ...
        table.render({
            ...
            ,cols: [[
                ...
                {field: 'type', title: '类型', minWidth: 80,align: 'center',templet:"#type"},

                {field: 'bonus_config', title: 'Bonus配置',align: 'center', minWidth: 120},
                {field: 'cash_config', title: 'Cash配置',align: 'center', minWidth: 120},
                {field: 'hot_config', title: '热销配置',align: 'center', minWidth: 120},
                {field: 'customer_money', title: '客损金额',align: 'center', minWidth: 120,templet(d){
                        return d.customer_money/100
                    }},
                {field: 'withdraw_bili', title: '提现率',align: 'center', minWidth: 120,templet(d){
                        return (d.withdraw_bili * 100) +'%'
                    }},
                ...
                {field: 'num', title: '参与次数',align: 'center', minWidth: 60},
                {field: 'status', title: '状态',align: 'center', minWidth: 120,templet:"#status"},
                {field: 'weight', title: '权重',align: 'center', minWidth: 60},
