    ...
    layui.use(['table','form','layer','laydate'], function () {
        ...
        table.render({
            ...
            ,cols: [[
                ...
                {field: 'money', title: '奖励Cash金额(分)',align: "center", minWidth: 130},
                {field: 'bonus', title: '奖励Bonus金额(分)',align: "center", minWidth: 130},
                {field: 'withdraw_bili', title: '退款比例低于多少',align: "center", minWidth: 130},
                {field: 'sycash', title: '剩余Cash(小数位比例,整数为金额)',align: "center", minWidth: 180},
                {field: 'water_multiple', title: '流水倍数小于多少',align: "center", minWidth: 120},
                {field: 'min_money', title: '最小充值金额',align: "center", minWidth: 120,templet(d){
                    return `${(d.min_money/100).toFixed(2)}`
                    }},
                {field: 'max_money', title: '最大充值金额',align: "center", minWidth: 120,templet(d){
                        return `${(d.max_money/100).toFixed(2)}`
                    }},
                {field: 'num', title: '参与次数/红包个数(-99表示无数个)',align: "center", minWidth: 120},
                {field: 'type', title: '类型',align: "center", minWidth: 120,templet: '#type'},
                {field: 'probability', title: '概率',align: "center", minWidth: 120},
