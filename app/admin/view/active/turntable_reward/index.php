...
<script type="text/html" id="terminal_type">
    {{# if(d.type == 1){ }}
    <span class="layui-btn layui-btn-primary layui-btn-xs layui-border-blue">累积取现额</span>
    {{# }else if(d.type == 2){ }}
    <span class="layui-btn layui-btn-primary layui-btn-xs layui-border-red">cash</span>
    {{# }else{ }}
    <span class="layui-btn layui-btn-primary layui-btn-xs layui-border-red">bouns</span>
    {{# }; }}
</script>
<script>
    ...
    layui.use(['table','form','layer','laydate'], function () {
        ...
        table.render({
            ...
            ,cols: [[
                ...
                {field: 'logo', title: '图标', minWidth: 110, templet(d) {
                        return  '<img class="image" src='+d.logo+' style="width:50px;height:50px">'
                    }},
                {field: 'reward', title: '奖励金额', minWidth: 80, sort: true},
                {field: 'reward_max', title: '奖励金额最大值', minWidth: 80, sort: true},
                {field: 'probability', title: '概率百分比', minWidth: 80, sort: true},
                {
                    field: 'type', title: '类型', minWidth: 80,templet:"#terminal_type"
                },
