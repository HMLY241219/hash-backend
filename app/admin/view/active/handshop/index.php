    ...
    layui.use(['table','form','layer','laydate'], function () {
        ...
        table.render({
            ...
            ,cols: [[
                ...
                {field: 'min_money', title: '最小输入金额',align: 'center', minWidth: 120, templet(d){
                        return d.min_money/100
                    }},
                {field: 'max_money', title: '最大输入金额',align: 'center', minWidth: 120, templet(d){
                        return d.max_money/100
                    }},

                {field: 'zs_cash', title: '赠送Cash比例',align: 'center', minWidth: 120,templet(d){
                        return (d.zs_cash * 100) +'%'
                    }},
                {field: 'zs_bonus', title: '赠送Bonus比例',align: 'center', minWidth: 120,templet(d){
                        return (d.zs_bonus * 100) +'%'
                    }},
