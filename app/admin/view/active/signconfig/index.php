...
<script type="text/html" id="type">
    {{# if(d.type == 1){ }}
    <span class="layui-btn layui-btn-xs layui-btn-normal">已充值</span>
    {{# }else{ }}
    <span class="layui-btn layui-btn-xs layui-btn-danger">未充值</span>
    {{# }; }}
</script>
<script>
    ...
    layui.use(['table','form','layer','laydate'], function () {
        ...
        table.render({
            ...
            ,cols: [[
                ...
                {field: 'start_money', title: '开始金额（分）',align: "center", minWidth: 120},
                {field: 'end_money', title: '结束金额（分）',align: "center", minWidth: 120},
                {field: 'cash', title: '奖励Cash配置',align: "center", minWidth: 180},
                {field: 'bonus', title: '奖励bonus配置',align: "center", minWidth: 180},
