    ...
    layui.use(['table','form','layer'], function () {
        ...
        table.render({
            ...
            ,cols: [[
                ...
                {field: 'coin', title: '余额', minWidth: 88 ,align: 'center',sort:true,templet: function (d){
                        return d.coin/100
                    }},
                ...
                // {field: 'now_score_water', title: '当前有效游戏流水',align: 'center',sort:true, minWidth: 150,templet(d){
                //         return d.now_score_water/100
                //     }},
                // {field: 'need_score_water', title: '当前要求游戏流水',align: 'center',sort:true, minWidth: 150,templet(d){
                ...
                {field: 'total_pay_score', title: '总充值Cash',align: 'center',sort:true, minWidth: 150,templet(d){
                ...
                {field: 'total_score', title: '玩家总SY(不含服务费)',align: 'center',sort:true, minWidth: 230,templet(d){
                        return d.total_score/100
                    }},
                {field: 'total_exchange', title: '总退款Cash',align: 'center',sort:true, minWidth: 150,templet(d){
                ...
                {fixed: 'right', title: '操作', align: 'center', minWidth: 450, toolbar: '#act'}
            ]]
