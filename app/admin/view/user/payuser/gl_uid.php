    ...
    layui.use(['table','form','layer','laydate'], function () {
        ...
        table.render({
            ...
            ,cols: [[
                ...
                {field: 'total_pay_score', title: '总充值金额',align: 'center', minWidth: 130,templet(d){
                        return `${(d.total_pay_score / 100).toFixed(2)}`
                    }},
                {field: 'total_exchange', title: '总TK金额',align: 'center', minWidth: 130,templet(d){
                        return `${(d.total_exchange / 100).toFixed(2)}`
                    }},
                {field: 'total_bili', title: '提现率',align: 'center', minWidth: 130,templet(d){
                        return `${(d.total_bili * 100).toFixed(2)}%`
                    }},
                {field: 'total_score', title: '总输赢',align: 'center', minWidth: 130,templet(d){
