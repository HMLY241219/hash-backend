                ...
                <div class="layui-card layui-form" lay-filter="form">
                    <div class="layui-card-body layui-row layui-col-space10">
                        ...
                        <!--<div class="layui-inline">
                            ...
                            <div class="layui-input-inline" style="width: 200px;">
                                <input name="min_rate" placeholder="最小退款率" class="layui-input" type="number">
                            </div>
                            <div class="layui-form-mid">-</div>
                            <div class="layui-input-inline" style="width: 200px;">
                                <input name="max_rate" placeholder="最大退款率" class="layui-input" type="number">
                            </div>
                        </div>-->
    ...
    layui.use(['table','form','layer'], function () {
        ...
        table.render({
            ...
            ,cols: [[
                ...
                {field: 'total_bili', title: '退款率',sort:true, minWidth: 120,templet(d){
                        return d.total_bili+'%'
                    }},
                {field: 'get_bonus', title: '领取bonus', minWidth: 120,sort:true},
                {field: 'zh_cash', title: '转化cash', minWidth: 120,sort:true},
