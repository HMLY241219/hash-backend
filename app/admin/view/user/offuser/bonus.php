...
<script type="text/html" id="reason">
    ...
    <!--    {{# }else if(d.reason == 7){ }}-->
    <!--    <span class="layui-btn layui-btn-primary layui-btn-xs " style="color:#f37b1d">钱包雨活动</span>-->
    {{# }else if(d.reason == 8){ }}
    ...
    layui.use(['table','form','layer','laydate'], function () {
        ...
        table.render({
            ...
            ,cols: [[
                ...
                {field: 'num', title: '赠送的Bonus',align: 'center', minWidth: 130,templet(d){
                        return `${(d.num / 100).toFixed(2)}`
                    }},
