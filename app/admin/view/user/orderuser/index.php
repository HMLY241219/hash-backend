...
<script>
    ...
    layui.use(['table','form','layer'], function () {
        ...
        var daydate = urlObj.searchParams.get('daydate');
        ...
        table.render({
            elem: '#table'
            ,defaultToolbar: []
            ,url: "{:url('getlist')}?id="+id+"&type="+type+"&daydate="+daydate
            ...
            ,cols: [[
                ...
                {field: 'regist_time', title: '注册时间', minWidth: 160},
                //{field: 'login_time', title: '最近登录时间', minWidth: 160},

                //{field: 'game_name_info', title: '所在游戏', minWidth: 130},
                {field: 'coin', title: '余额', minWidth: 88 ,sort:true,templet: function (d){
                        return d.coin/100
                    }},
                {field: 'total_pay_score', title: '总充值',sort:true, minWidth: 100,templet(d){
                        return d.total_pay_score/100
                    }},
                {field: 'total_exchange', title: '总退款',sort:true, minWidth: 100,templet(d){
                        return d.total_exchange/100
                    }},
                {field: 'get_bonus', title: '总赠送bonus',sort:true, minWidth: 100,templet(d){
                        return d.get_bonus/100
                    }},
                {field: 'bonus_cash', title: '转化cash金额',sort:true, minWidth: 100,templet(d){
                        return d.bonus_cash/100
                    }},

                {field: 'bonus_water_multiple', title: 'bonus流水倍数',sort:true, minWidth: 100,templet(d){
                        return d.bonus_water_multiple
                    }},
                {field: 'cash_water_multiple', title: 'cash流水倍数',sort:true, minWidth: 100,templet(d){
                        return d.cash_water_multiple
                    }},
                /*{field: 'total_give_score', title: '总赠送',sort:true, minWidth: 100,templet(d){
                        return d.total_give_score/100
                    }},*/

                {field: 'total_pay_num', title: '总充值次数',sort:true, minWidth: 100},
                {field: 'total_exchange_num', title: '总退款次数',sort:true, minWidth: 100},
                {field: 'total_bili', title: '总退款率',sort:true, minWidth: 110,templet(d){
                        return (d.total_bili*100).toFixed(2) + '%'
                    }},
                {field: 'total_score', title: '总SY',sort:true, minWidth: 110,templet(d){
                        return (d.cash_total_score + d.bonus_total_score)/100
                    }},
                {field: 'daytotal_pay_score', title: '当日充值',sort:true, minWidth: 110,templet(d){
                        return d.daytotal_pay_score/100
                    }},
                {field: 'daytotal_exchange', title: '当日退款',sort:true, minWidth: 110,templet(d){
                        return d.daytotal_exchange/100
                    }},
                /*{field: 'first_pay_score', title: '首充',sort:true, minWidth: 88,templet(d){
                        return d.first_pay_score/100
                    }},
                {field: 'last_pay_price', title: '尾充',sort:true, minWidth: 88,templet(d){
                        return d.last_pay_price/100
                    }},
                {field: 'total_game_day', title: '游戏天数',sort:true, minWidth: 110},
                {field: 'not_play_game_day', title: '连续未游戏天数',sort:true, minWidth: 160},

                    {field: 'daytotal_give_score', title: '当日赠送',sort:true, minWidth: 110,templet(d){
                        return d.daytotal_give_score/100
                    }},
                {field: 'day_total_bili', title: '日退款率', minWidth: 110,templet(d){
                        return (d.day_total_bili*100).toFixed(2) + '%'
                    }},
                {field: 'daytotal_score', title: '日SY',sort:true, minWidth: 100,templet(d){
                        return d.daytotal_score/100
                    }},
                {field: 'now_score_water', title: '有效流水',sort:true, minWidth: 110,templet(d){
                        return d.now_score_water/100
                    }},
                {field: 'need_score_water', title: '要求流水',sort:true, minWidth: 110,templet(d){
                        return d.need_score_water/100
                    }},
                {field: 'pttotal_score', title: '平台总SY',sort:true, minWidth: 110,templet(d){
                        return d.pttotal_score/100
                    }},
   /!*             {field: 'sftotal_outside_score', title: '三方总SY',sort:true, minWidth: 110,templet(d){
