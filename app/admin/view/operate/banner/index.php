...
<script type="text/html" id="url_type">
    {{# if(d.url_type == 1){ }}
    <span class="layui-btn layui-btn-primary layui-btn-xs layui-border-blue">活动Banner</span>
    {{# }else if(d.url_type == 2){ }}
    <span class="layui-btn layui-btn-primary layui-btn-xs layui-border-red">网页Banner</span>
    {{# }else if(d.url_type == 3){ }}
    <span class="layui-btn layui-btn-primary layui-btn-xs layui-border-blue">签到弹窗</span>
    {{# }else if(d.url_type == 4){ }}
    <span class="layui-btn layui-btn-primary layui-btn-xs layui-border-blue">cashback弹窗</span>
    {{# }else if(d.url_type == 5){ }}
    <span class="layui-btn layui-btn-primary layui-btn-xs layui-border-blue">宝箱弹窗</span>
    {{# }else{ }}
    <span class="layui-btn layui-btn-primary layui-btn-xs layui-border-green">客户端Banner</span>
    {{# }; }}
</script>
<script type="text/html" id="end_type">
    ...
    {{# }else{ }}
    <span class="layui-btn layui-btn-primary layui-btn-xs layui-border-green">新包</span>
    {{# }; }}
</script>
    ...
    layui.use(['table','form','layer','laydate'], function () {
        ...
        table.render({
            ...
            ,cols: [[
                ...
                {field: 'title', title: 'Banner', minWidth: 110},
                {field: 'image', title: '图片', minWidth: 110, templet(d) {
                        return  '<img class="image" src='+d.image+' style="width:50px;height:50px">'
                    }},
                {field: 'weight', title: '权重', minWidth: 80, sort: true},
                {
                    field: 'url_type', title: 'Banner类型', minWidth: 100,templet:"#url_type"
                },
                {
                    field: 'end_type', title: '端类型', minWidth: 100,templet:"#end_type"
                },
                {
