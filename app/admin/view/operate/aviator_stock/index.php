...
<script type="text/html" id="act">
    <span class="layui-btn layui-btn-xs layui-btn-warm" onclick="$eb.createModalFrame(this.innerText,`{:url('edit')}?key={{d.key}}`)">编辑</span>
</script>
...
<script>
    ...
    layui.use(['table','form','layer','laydate'], function () {
        ...
        table.render({
            ...
            ,page : false
            ,cols: [[
                {field: 'key', title: '键名', minWidth: 40},
                {field: 'name', title: '名称', minWidth: 120},
                {field: 'value', title: '库存', minWidth: 120,templet(d) {
