    ...
    <div class="col-sm-12">
        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-title">
                <button type="button" class="btn btn-w-m btn-primary add-filed" onclick="openIframe(this.innerText,'{:Url('create')}')">配置分类</button>
                <button type="button" class="btn btn-w-m btn-primary add_filed_base" onclick="openIframe(this.innerText,'{:Url('setting.systemConfig/create',['type'=>0])}')">添加配置</button>
            </div>
                    ...
                    <table class="table table-striped  table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <button class="btn btn-info btn-xs" type="button"  onclick="openIframe('编辑','{:Url('setting.system_config/edit_config',array('id'=>$vo['id']))}')"><i class="fa fa-edit"></i> 编辑</button>
