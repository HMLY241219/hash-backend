...
<div class="row">
    <div class="col-sm-12">
        <div class="ibox">
            <!--{if condition ="($admin.type == 0 || $admin.id==39 || $admin.id==40)"}-->
            <div class="ibox-title">
                <button type="button" class="btn btn-w-m btn-primary" onclick="$eb.createModalFrame(this.innerText,'{:Url('create')}')">开账号</button>
                ...
                <div class="table-responsive">
                    <table class="table table-striped  table-bordered">
                        ...
                        <tr>
                            ...
                            {if condition ="($admin.level eq 0)"}
                            <th class="text-center">谷歌秘钥</th>
                            {/if}
