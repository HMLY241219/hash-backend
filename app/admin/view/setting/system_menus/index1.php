    ...
    <div class="col-sm-12">
        <div class="ibox">
            <div class="ibox-title">
                ...
                <button type="button" class="btn btn-w-m btn-primary" onclick="openIframe(this.innerText,'{$addurl}')">添加规则</button>
...
<!--                            <th class="text-center">子管理员可用</th>-->
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <button class="btn btn-info btn-xs" type="button"  onclick="openIframe(this.innerText,'{:url('create',array('cid'=>$vo['id']))}')"><i class="fa fa-plus-square"></i> 添加子菜单</button>
                                <button class="btn btn-info btn-xs" type="button"  onclick="openIframe(this.innerText,'{:url('edit',array('id'=>$vo['id']))}')"><i class="fa fa-edit"></i> 编辑</button>
