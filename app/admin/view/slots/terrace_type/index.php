...
<script type="text/html" id="jump_type">
    {{# if(d.jump_type == 4){ }}
    <span class="layui-btn layui-btn-primary layui-btn-xs layui-border-blue" style="color: #7F007F">游戏大厅</span>
    {{# }else{ }}
    <span class="layui-btn layui-btn-primary layui-btn-xs layui-border-orange" style="color: #b084eb">游戏</span>
    {{# }; }}
</script>
<script>
    ...
    layui.use(['table','form','layer','laydate'], function () {
        ...
        table.render({
            ...
            ,cols: [[
                ...
                {field: 'icon', title: '图标', minWidth: 110, templet(d) {
                        return  '<img class="image" src='+d.icon+' style="width:50px;height:50px">'
                    }},
                {
                    field: 'jump_type', title: '状态', minWidth: 100,templet:"#jump_type"
                },
