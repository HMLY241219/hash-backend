...
<script>
    ...
    (function () {
        ...
        const div = $(".ivu-col-span-10 .ivu-input-type").parents(".ivu-form-item");
        if (div) {
            div.find(".ivu-form-item-label").hide();
            div.find(".ivu-form-item-content").css("margin-left", "10px");
        }
        <?php } ?>
    })();
</script>
