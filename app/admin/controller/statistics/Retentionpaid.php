 ...
 *  付费留存-再付费
 */
class Retentionpaid extends AuthController
{

    private $table = 'statistics_retentionpaid';
    ...
    public function userList(){
        ...
        $user_day_table = 'user_day_'.date('Ymd',$time + ($type*86400));
        $users = Db::name($user_day_table)->whereIn('uid',$all_users)->where('total_pay_score','>',0)->column('uid');
        $users = implode(",",$users);
